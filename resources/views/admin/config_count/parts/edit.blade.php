...
{{--                                </div>--}}
{{--                            </div>--}}
                            <input type="hidden" name="type" value="{{ $configCountData['type'] }}">
                            <div class="row">
                                <div class="col-md-6">
                        ...
                        <div class="modal-footer">
                            <a href="{{ route('config_count.index',['type'=>$configCountData['type']]) }}" class="btn btn-info text-white">رجوع للخلف</a>
